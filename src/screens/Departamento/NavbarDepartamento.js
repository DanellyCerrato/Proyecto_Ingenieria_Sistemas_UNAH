        ...
        <div>
            ...
            >
                ...
                <div className="hidden lg:flex lg:gap-x-12">

                    {
                        routes.map((route, key) => {
                            return (
                                <NavLink key={key} to={route.path} className={({ isActive }) =>
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end ">
                    <NavLink to="/login?tipo=departamento" className="text-lg font-semibold leading-6 text-sky-50 hover:text-sky-950">
...
export default NavbarDepartamento